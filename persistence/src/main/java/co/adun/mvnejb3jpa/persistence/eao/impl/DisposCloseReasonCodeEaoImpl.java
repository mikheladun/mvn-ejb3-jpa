...
@Stateless
@Transactional
public class DisposCloseReasonCodeEaoImpl extends BaseEaoImpl<DisposCloseReasonCode> implements DisposCloseReasonCodeEao
{
	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(DisposCloseReasonCodeEaoImpl.class.getName());

	@Override
	public Class<DisposCloseReasonCode> getEntityClass()
	{
		return DisposCloseReasonCode.class;
	}
}